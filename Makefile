...
all: dirs $(AI_BINAIRIES) $(COM_BINAIRIES) $(DATA_BINAIRIES) $(SKILLS_BINAIRIES) $(UTILS_BINAIRIES) $(SERVER_BINAIRIES) \
...
$(TARGET_CLIENT_TERMINAL): $(AI_BINAIRIES) $(COM_BINAIRIES) $(DATA_BINAIRIES) $(SKILLS_BINAIRIES) $(UTILS_BINAIRIES) $(CLIENT_TERMINAL_BINAIRIES)
	$(CC) $(CC_FLAGS) $(CC_INCLUDE) $^ -o $@

$(TARGET_CLIENT_GRAPHICS): $(AI_BINAIRIES) $(COM_BINAIRIES) $(DATA_BINAIRIES) $(SKILLS_BINAIRIES) $(UTILS_BINAIRIES) $(CLIENT_GRAPHICS_BINAIRIES)
	$(CC) $(CC_FLAGS) $(CC_INCLUDE) $^ -o $@
